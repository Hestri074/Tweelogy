                    ...
                    <section id="home">
                      ...
                      <table >
                        <tr>
                          <td>
                          <div class="chart">
                            <b>Grafik Penjualan Produk</b>
                            <a href="grafik_penjualan.php" class="btn btn" style="color: white; border: 4px solid black; border-radius: 0.6em;">
                            <canvas id="chart" class="chart-canvas"width="450" height ="350" ></canvas>
                            </a>
                          </div>
                          </td>
                          <td style="position: relative; left: 50px">
                          <div class="chart">
                            <b>Grafik Stok Produk</b>
                            <a href="grafik_stok_produk.php" class="btn btn" style="color: white; border: 4px solid black; border-radius: 0.6em;" >
                            <canvas id="bar-chart" class="bar-chart-canvas" width="450" height ="350"></canvas>
                            </a>
                          </div>
                          </td>
                        </tr>
